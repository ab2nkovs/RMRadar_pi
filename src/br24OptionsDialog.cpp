...
br24OptionsDialog::br24OptionsDialog(wxWindow *parent, PersistentSettings &settings, RadarType radar_type)
  ...
  m_controlEnable = new wxCheckBox(this, wxID_ANY, _("Enable radar control"), wxDefaultPosition, wxDefaultSize,
                                     wxALIGN_CENTRE | wxST_NO_AUTORESIZE);
  itemStaticBoxSizerOptions->Add(m_controlEnable, 0, wxALL, border_size);
  m_controlEnable->SetValue(m_settings.enable_transmit ? true : false);
  m_controlEnable->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(br24OptionsDialog::OnEnableTransmitClick), NULL,
                             this);
...
void br24OptionsDialog::OnEnableTransmitClick(wxCommandEvent &event) 
{
  m_settings.enable_transmit = m_controlEnable->GetValue();
}
